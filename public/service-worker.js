// Caches data when there is no internet connection
const CACHE_NAME = "my-site-cache-v1";
const DATA_CACHE_NAME = "data-cache-v1";

// Providing an array of all urls that our PWA should cache
const urlsToCache = [
  "/",
  "/db.js",
  "/index.js",
...
// Allows a web app to be installed ad a standalone PWA
